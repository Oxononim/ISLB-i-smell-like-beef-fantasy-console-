...
ping localhost -n 1 >nul
cls
echo d888888b .d8888. db      d8888b.   db    db .d888b.    .d888b.
echo   `88'   88'  YP 88      88  `8D   88    88 VP  `8D    88   8D
echo    88    `8bo.   88      88oooY'   Y8    8P    odD'    `VoooY'
echo    88      `Y8b. 88      88~~~b.   `8b  d8'  .88'      .d~~~b.
echo   .88.   db   8D 88booo. 88   8D    `8bd8'  j88.    db 88   8D
echo Y888888P `8888Y' Y88888P Y8888P'      YP    888888D VP `Y888P'
echo.
echo                       e
echo.
echo                                 1) start
...
:info
CLS 
echo heya! this is version 2.9 of i smell like beef!
