...
title ISLB_V2.9
set /a val=%random% %%5
if %val% equ 1 goto cheese!
if %val% equ 2 goto Wash!
if %val% equ 3 goto ass.
if %val% equ 4 goto GIT!
...
ping localhost -n 1 >nul
cls
echo d888888b .d8888. db     
echo   `88'   88'  YP 88     
echo    88    `8bo.   88     
echo    88      `Y8b. 88     
echo   .88.   db   8D 88booo.
echo Y888888P `8888Y' Y88888P
echo.
echo.
echo.
echo  [42;37m                                1) start[0m
...
ping localhost -n 1 >nul
cls
echo d888888b .d8888. db      d8888b.   
echo   `88'   88'  YP 88      88  `8D   
echo    88    `8bo.   88      88oooY'   
echo    88      `Y8b. 88      88~~~b.   
echo   .88.   db   8D 88booo. 88   8D   
echo Y888888P `8888Y' Y88888P Y8888P'   
echo.
echo.
echo.
echo  [42;37m                                1) start[0m
...
ping localhost -n 1 >nul
cls
echo d888888b .d8888. db      d8888b.   db    db
echo   `88'   88'  YP 88      88  `8D   88    88
echo    88    `8bo.   88      88oooY'   Y8    8P
echo    88      `Y8b. 88      88~~~b.   `8b  d8'
echo   .88.   db   8D 88booo. 88   8D    `8bd8' 
echo Y888888P `8888Y' Y88888P Y8888P'      YP   
echo.
echo.
echo.
echo  [42;37m                                1) start[0m
...
ping localhost -n 1 >nul
cls
echo d888888b .d8888. db      d8888b.   db    db .d888b.
echo   `88'   88'  YP 88      88  `8D   88    88 VP  `8D
echo    88    `8bo.   88      88oooY'   Y8    8P    odD'
echo    88      `Y8b. 88      88~~~b.   `8b  d8'  .88'  
echo   .88.   db   8D 88booo. 88   8D    `8bd8'  j88.   
echo Y888888P `8888Y' Y88888P Y8888P'      YP    888888D
echo.
echo.
echo.
echo  [42;37m                                1) start[0m
...
echo    88    `8bo.   88      88oooY'   Y8    8P    odD'    
echo    88      `Y8b. 88      88~~~b.   `8b  d8'  .88'      
echo   .88.   db   8D 88booo. 88   8D    `8bd8'  j88.    db 
echo Y888888P `8888Y' Y88888P Y8888P'      YP    888888D VP 
echo.
echo.
echo.
echo  [42;37m                                1) start[0m
...
ping localhost -n 1 >nul
cls
echo d888888b .d8888. db      d8888b.   db    db d8888b.     .d88b.  
echo   `88'   88'  YP 88      88  `8D   88    88 VP  `8D    .8P  88. 
echo    88    `8bo.   88      88oooY'   Y8    8P   oooY'    88  d'88 
echo    88      `Y8b. 88      88~~~b.   `8b  d8'   ~~~b.    88 d' 88 
echo   .88.   db   8D 88booo. 88   8D    `8bd8'  db   8D db `88  d8' 
echo Y888888P `8888Y' Y88888P Y8888P'      YP    Y8888P' VP  `Y88P'  
echo.
echo                       e
echo.
echo  [42;37m                                1) start[0m
...
:info
CLS 
echo heya! this is version 3.0 of i smell like beef!
